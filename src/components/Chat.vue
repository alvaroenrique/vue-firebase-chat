      ...
      <v-card>
        ...
        <v-list two-line>
          <template v-for="(item, index) in items">
            <v-subheader v-if="item.header" :key="item.header">{{ item.header.toLocaleString() }}</v-subheader>
    ...
    return {
      items: [
        { header: new Date() },
        {
          ...
          title:
            "Brunch this weekend? loremasdjlaskdjlkajsdlkjasldkjaslkdjaslkdjalskdlaksjdlkj",
          subtitle:
